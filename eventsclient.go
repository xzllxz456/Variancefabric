...
func readCLInputs() {
	flag.StringVar(&serverAddr, "server", "peer0:7051", "The RPC server to connect to.")
	...
	flag.StringVar(&clientKeyPath, "clientKey", "/home/rathon/go/testnet/crypto-config/peerOrganizations/org0/peers/peer0.org0/tls/server.key", "Specify path to the client TLS key")
	flag.StringVar(&clientCertPath, "clientCert", "/home/rathon/go/testnet/crypto-config/peerOrganizations/org0/peers/peer0.org0/tls/server.crt", "Specify path to the client TLS certificate")
	flag.StringVar(&serverRootCAPath, "rootCert", "/home/rathon/go/testnet/crypto-config/peerOrganizations/org0/peers/peer0.org0/tls/ca.crt", "Specify path to the server root CA certificate")
...
func initMSP() {
	...
	var mspMgrConfigDir = "/home/rathon/go/testnet/crypto-config/peerOrganizations/org0/users/Admin@org0/msp"
	var mspID = "Org1MSP"
	var mspType = "bccsp"
...
func saveFilteredLog() {
	...
	jsonBytes, err := ioutil.ReadFile("./home/rathon/go/testnet/log/tmpblockhistory.log"); if err != nil { panic(err) }
	file, err := os.OpenFile("./home/rathon/go/testnet/log/filteredblockhistory.log", os.O_CREATE|os.O_WRONLY|os.O_APPEND, 0666)
	if err != nil {	fmt.Printf("  File write error !" )	}
